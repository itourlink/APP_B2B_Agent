...
=======
          <Copy
            ...
            onClick={(e) => {
              ...
              showToast("success", t("copyServiceNameSuccess"));
            }}
          />
>>>>>>> 08595bbf7511f83955b01899cbac1ff02ec5579b
        </div>
      ),
    },
    {
      field: "No",
      headerName: t("tourDate"),
      render: (_, row) => (
        <div className="text-xs text-gray-500 flex items-center gap-1.5 min-w-[320px]">
          <Calendar size={13} className="text-gray-400" />
          <span>
            {fDateTime(row?.dtmDateFrom) ?? "---"} -{" "}
            {fDateTime(row?.dtmDateTo) ?? "---"}
          </span>
        </div>
      ),
    },
          ...
          search={[
            {
              keySearch: "nameTour",
              value: filters.nameTour,
              placeHoder: t("searchServiceName"),
            },
          ]}
        />
