...
const AddToursD = () => {
  ...
  const payload = useMemo(
    () => ({
      ...
      strFilterServiceName: values.displayName || null,
      strListEasiaCateID: values.type || null,
      strListTransportOptionID: null,
      dtmFilterDateStart: "1/1/2025",
      dtmFilterDateValidFrom: values.from || null,
      dtmFilterDateValidTo: values.to || null,
      strOrder: null,
      strPriceFromRange: values.star || "",
