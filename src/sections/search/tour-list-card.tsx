            ...
            <div className="p-4 flex flex-col flex-grow">
                ...
                <div className="space-y-2 mb-4 text-sm text-gray-600">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="truncate">
                            Bởi: {String(isValidValue(tour?.strOwnerCompanyName))}
                        </span>
                    </div>
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <span>
                            Thời lượng:{" "}
                            {String(isValidValue(tour?.intNoOfDay))} Ngày - {Number(isValidValue(tour?.intNoOfDay) - 1)} Đêm
                        </span>
                    </div>
                ...
                <div className="mb-4">
                    <span className="bg-[#e6f0ff] text-[#3b82f6] text-xs font-medium px-3 py-1 rounded-full">
                        {String(isValidValue(tour?.strLangCode)) ===
                            "CATEID_SETTOUR"
                            ? "Tour hằng ngày"
                            : "Trọn gói"}{" "}
                        -{" "}
                ...
                <div className="mt-auto pt-4 border-t border-gray-100 flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-[#2563eb] font-bold text-xl">
                            {formatPrice(
                                Number(isValidValue(tour?.dblPriceFrom))
                            )}
                        </p>
                    </div>
